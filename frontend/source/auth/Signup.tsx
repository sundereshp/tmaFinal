...
export default function Signup() {
  ...
  const checkEmailAvailability = async (email: string) => {
    ...
    try {
      const response = await fetch(`http://vw.aisrv.in/new_backend/check-email?email=${encodeURIComponent(email)}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://vw.aisrv.in/new_backend/users", {
        method: "POST",
        headers: {
